...
namespace LCBusService.Models
{
    ...
    {
        public BusServiceContext(DbContextOptions<BusServiceContext> options) : base(options)
        {
        }
    }
    public partial class BusServiceContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-04HEVRJ;Database=BusService;Trusted_Connection=True");
        }
        */
